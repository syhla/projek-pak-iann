...
<div class="container mx-auto max-w-6xl px-4 py-10">
  ...
  {{-- Kontak + Form Komentar untuk Guest dan Customer --}}
          ...
          @guest
            <div class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 rounded-md shadow mb-4">
              <p class="text-sm">
                ...
                <a href="{{ route('login') }}" class="underline font-semibold text-yellow-800 hover:text-yellow-900">Login</a> 
                atau 
                <a href="{{ route('register') }}" class="underline font-semibold text-yellow-800 hover:text-yellow-900">Register</a> 
                terlebih dahulu.
              </p>
            </div>
          @endguest
          ...
          @auth
            @if(Auth::user()->hasRole('customer'))
              <form action="{{ route('comments.store') }}" method="POST" class="mt-6 space-y-4">
                ...
                <label for="pesan" class="block text-base text-gray-700 mb-4">
                ...
                <textarea
                  ...
                  class="w-full px-4 py-3 text-gray-800 placeholder-gray-400 border border-[#556B2F]/40 rounded-md focus:ring-2 focus:ring-[#556B2F] focus:border-[#556B2F] transition duration-200 ease-in-out resize-none shadow-sm"
                >{{ old('pesan') }}</textarea>
                ...
                <button
                  type="submit"
                  class="bg-[#556B2F] hover:bg-[#4a5a22] text-white font-medium px-6 py-2 rounded-md transition duration-300 ease-in-out"
                >
                  Kirim Komentar
                </button>
              </form>
...
<div x-data="{ filter: 'approved' }" class="p-8 mx-auto">
    ...
    <div class="relative mb-8 w-full md:w-1/3 mx-auto">
        ...
        <select id="filter" x-model="filter"
            class="block w-full px-4 py-2 text-sm border border-gray-300 rounded-lg shadow-sm
                   focus:ring-2 focus:ring-[#556B2F] focus:border-[#556B2F] bg-white
...
{{-- Peta Google Maps --}}
@guest
    {{-- Tampilkan peta untuk guest --}}
    <div class="mt-16 rounded-xl shadow-xl overflow-hidden">
        <iframe 
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d126915.04866170468!2d106.68943262506666!3d-6.229386897788109!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f3c4d8bbef41%3A0x3f1e21a87e0d9a9a!2sJakarta%2C%20Indonesia!5e0!3m2!1sen!2sus!4v1684333790697!5m2!1sen!2sus"
            width="100%" 
            height="350" 
            style="border:0;" 
            allowfullscreen 
...
@auth
    @if(Auth::user()->hasRole('pengunjung'))
        {{-- Tampilkan peta untuk user dengan role pengunjung --}}
        <div class="mt-16 rounded-xl shadow-xl overflow-hidden">
            <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d126915.04866170468!2d106.68943262506666!3d-6.229386897788109!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f3c4d8bbef41%3A0x3f1e21a87e0d9a9a!2sJakarta%2C%20Indonesia!5e0!3m2!1sen!2sus!4v1684333790697!5m2!1sen!2sus"
                width="100%" 
